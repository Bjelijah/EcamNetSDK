...
public class MyReceive extends BroadcastReceiver {
    ...
    private void queryDeviceRecords(final String deviceId, String time){
        ...
        Date datePush = MyUtil.ISODateString2ISODate(time);
        ...
        final String begTime = MyUtil.Date2ISODate(dateBefore);//fixme 触发事件的前一分钟
        final String endTime = MyUtil.Date2ISODate(dateAfter);//fixme 触发事件的后一分钟
