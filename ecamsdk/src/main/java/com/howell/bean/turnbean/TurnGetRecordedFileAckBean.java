...
public class TurnGetRecordedFileAckBean {
	...
	int channel;
	int recordFileCount;
	ArrayList<RecordedFile> recordedFiles;
	...
	public ArrayList<RecordedFile> getRecordedFiles() {
		return recordedFiles;
	}

	public void setRecordedFiles(ArrayList<RecordedFile> recordedFiles) {
	...
	public String toString() {
		return "TurnGetRecordedFileAckBean{" +
				"code=" + code +
				", detail='" + detail + '\'' +
				", deviceID='" + deviceID + '\'' +
				", channel=" + channel +
